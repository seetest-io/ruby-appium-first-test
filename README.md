...
You can clone the repository to your machine and open it in your IDE of choice. To run the test, run the command *parallel_test android_app_test.rb android_web_test.rb ios_app_test.rb ios_web_test.rb*. You can also run each test separately should you choose to.
The tests rely on an access key that allows you to send test requests to seetest.io cloud. In the code, the access key tries to look for an access key as environment variable. If you haven't configured an access key as environment variable, you will have to specify it directly in the code.
...
### [Using seetest.io with Jenkins](https://docs.seetest.io/display/SEET/Running+a+Ruby+Jenkins+Job)
